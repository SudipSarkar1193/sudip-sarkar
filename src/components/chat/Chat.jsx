...
const Chat = ({ isChatOpen, setIsChatOpen }) => {
  ...
  return (
    <div className="fixed inset-0 flex items-center justify-end z-30 md:p-4">
      <div className="bg-white dark:bg-gray-800 w-full max-w-md md:h-[75vh] h-screen rounded-lg shadow-2xl flex flex-col animate-fadeIn">
        {/* Chat Header */}
